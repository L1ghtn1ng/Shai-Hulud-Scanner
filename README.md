...
**Performance**: Scans run in parallel for faster execution.
...
1. Download the latest release version appropriate to your platform(s)
...
| `compromised-namespace` | Warning | Package from compromised org |
...
The scanner flags dependencies from the following npm namespaces that have been compromised:
